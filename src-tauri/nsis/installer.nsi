...
; 8. Custom options page: desktop shortcut + autostart
...
Function InstallOptionsPage
  ...
  !insertmacro MUI_HEADER_TEXT "$(^FinishPage_Title)" "Выберите дополнительные параметры"

  ${NSD_CreateLabel} 0 0 100% 16u "Выберите дополнительные действия после установки:"
  Pop $0

  ${NSD_CreateCheckbox} 10u 24u 100% 12u "Создать ярлык на рабочем столе"
  Pop $DesktopShortcutCheckbox
  ${NSD_SetState} $DesktopShortcutCheckbox ${BST_CHECKED}

  ${NSD_CreateCheckbox} 10u 44u 100% 12u "Запускать при старте Windows (в свёрнутом виде)"
...
Section Install
  ...
  ; GUI installer has checkboxes on the options page to control creating them
