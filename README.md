...
> **Windows 7 / 8 / 8.1 не поддерживаются** — Microsoft прекратила поддержку WebView2 для этих систем с января 2023 года. Без WebView2 Runtime приложение не запустится.
